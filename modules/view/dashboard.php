...
// Filter validation
$allowed_filters = ['nama_barang', 'jumlah', 'harga', 'id'];
$filter_by = isset($_GET['filter_by']) && in_array($_GET['filter_by'], $allowed_filters) ? $_GET['filter_by'] : 'nama_barang';
        ...
        <div class="flex items-center space-x-4">
            <div class="relative">
                ...
                <div id="dropdownMenu" class="absolute font-semibold right-0 mt-2 w-40 bg-white border rounded-lg shadow-lg hidden">
                    <a href="auth/logout" class="block px-4 py-2 text-gray-800 hover:bg-gray-100"><i class="fa-solid fa-right-from-bracket"></i> Logout</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container mx-auto mt-5 p-6 bg-white rounded-lg shadow-md">
        <div class="flex justify-between mb-5">
            ...
            <div class="flex gap-3">
                <a class='inline-block text-center content-center bg-yellow-500 text-white rounded px-4 py-1 hover:opacity-80 transition font-bold' href='/import'><i class="fa-solid fa-file-import"></i> Import</a>
                <div class="relative">
                    <button class="inline-block h-full text-center content-center bg-blue-500 text-white rounded px-4 py-1 hover:opacity-80 transition font-bold" onclick="toggleExportDropdown()">
                        <i class="fa-solid fa-file-export"></i> Export
                    </button>
                    <div id="exportDropdown" class="absolute font-semibold right-0 mt-2 w-40 bg-white border rounded-lg shadow-lg hidden">
                        <a href="/export" class="block px-4 py-2 text-gray-800 hover:bg-gray-100 transition"><i class="fa-solid fa-file-csv"></i> CSV</a>
                        <a href="/export" class="block px-4 py-2 text-gray-800 hover:bg-gray-100 transition"><i class="fa-solid fa-file-excel"></i> Excel</a>
                        <a href="/export" class="block px-4 py-2 text-gray-800 hover:bg-gray-100 transition"><i class="fa-solid fa-file-code"></i> JSON</a>
                        <a href="/export" class="block px-4 py-2 text-gray-800 hover:bg-gray-100 transition"><i class="fa-solid fa-file-code"></i> XML</a>
                    </div>
                </div>
                ...
                <a class='inline-block text-center content-center bg-green-500 text-white rounded px-4 py-1 hover:opacity-80 transition font-bold' href='/add'><i class="fa-solid fa-plus"></i> Add</a>
            </div>
        </div>
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<tr class='$rowClass hover:bg-gray-200'>
                                ...
                                <td class='py-2 px-4 text-center'>
                                    <a class='inline-block bg-green-500 text-white rounded px-3 py-1 hover:opacity-80 transition' href='/edit?id=" . $row["id"] . "'><i class='fa-solid fa-pen-to-square'></i></a>
                                    <a class='inline-block bg-red-500 text-white rounded px-3 py-1 hover:opacity-80 transition' href='/delete?id=" . $row["id"] . "&search=" . htmlspecialchars($search) . "&page=" . $page . "' onclick='return confirm(\"Are you sure you want to delete this item?\")'><i class='fa-solid fa-trash'></i></a>
                                </td>
                              </tr>";
                        $counter++;
                    }
